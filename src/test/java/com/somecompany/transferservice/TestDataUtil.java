...
public class TestDataUtil {
    ...
    public UUID TEST_ACCOUNT_1_UUID = UUID.fromString("beb15528-4348-4201-aca5-f2e2c9a09bfb");
    ...
    private Account createTestAccountOwner1() {
        ...
        account.setUuid(TEST_ACCOUNT_1_UUID);
    ...
    private Account createTestAccountOwner2() {
        ...
        account.setUuid(TEST_ACCOUNT_2_UUID);
    ...
    private OpenExchangeRatesLatestDto createOerResultDto()  {
        File file = new File("src/test/resources/responses/oerlatest-response.json");
        try {
